...
Este projeto consiste em efetuar um processamento de dados utilizando os plataformas EMR, para processamento e gerenciamento do Hadoop, e S3, para armazenamento, do serviço da AWS. Esse processamento irá efetuar a contagem de cada palavra do arquivo de teste em questão.
